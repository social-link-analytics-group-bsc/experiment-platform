...
class User(models.Model):
    ...
    time_index = models.DecimalField(max_digits=5, decimal_places=0)
    time_news1 = models.DecimalField(max_digits=5, decimal_places=0)
    time_news2 = models.DecimalField(max_digits=5, decimal_places=0)
    time_answer = models.DecimalField(max_digits=5, decimal_places=0)
    time_demo = models.DecimalField(max_digits=5, decimal_places=0)
    time_rutina = models.DecimalField(max_digits=5, decimal_places=0)
    time_result = models.DecimalField(max_digits=5, decimal_places=0)
